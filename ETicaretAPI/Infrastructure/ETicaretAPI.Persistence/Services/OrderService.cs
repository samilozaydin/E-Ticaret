...
namespace ETicaretAPI.Persistence.Services
{
    public class OrderService : IOrderService
    {
        ...
        public async Task CreateOrder(CreateOrder createOrder)
        {
            ...
            var newOrderCode = orderCode.Substring(orderCode.IndexOf(",") + 1, orderCode.Length - orderCode.IndexOf(",") - 1);
        ...
        public async Task<ListOrder> GetAllOrders(int page, int size)
        {
            ...
            var query = _orderReadRepository.Table.Include(o => o.Basket)
                ...
                .Include(o => o.Basket)
                    ...
                    .ThenInclude(bt => bt.Product);


            var data = query.Skip(page * size).Take(size);

            var data2 = from o in data
                   join c in _completedOrderReadRepository.Table
                   on o.Id equals c.OrderId into co
        ...
        public async Task<SingleOrder> GetOrderById(string id)
        {
            ...
            var data2 = await (from o in data
                        join c in _completedOrderReadRepository.Table
                        on o.Id equals c.OrderId into co
                        from _co in co.DefaultIfEmpty()
                        select new
